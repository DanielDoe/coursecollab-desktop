...
const MODULES = {
  ...
  "ai-monitoring": { href: `${base}/analytics/ai-monitoring`, label: "AI Monitoring", icon: Activity },
  "ai-insights": { href: `${base}/analytics/ai-insights`, label: "AI Insights", icon: TrendingUp },
