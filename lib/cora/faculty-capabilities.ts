...
const MODULES = {
  ...
  "student-progress": { href: `${base}/analytics?section=student-progress`, label: "Class Analytics", icon: BarChart3 },
  reports: { href: `${base}/analytics?section=reports`, label: "Manage Reports", icon: FileText },
  "cora-insights": { href: `${base}/analytics/cora-insights`, label: "Cora Insights", icon: Activity },
  "ai-monitoring": { href: `${base}/analytics/cora-insights`, label: "Cora Insights", icon: Activity },
  "ai-insights": { href: `${base}/analytics/cora-insights`, label: "Cora Insights", icon: TrendingUp },
