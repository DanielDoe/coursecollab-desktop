...
import { InstructorGradesContent } from "@/components/instructor/InstructorGradesContent"

export default function AssessmentsGradesPage() {
  return (
    <motion.div
    ...
    >
      <CardWrapper delay={0} hover={false}>
        <div className="w-full min-w-0 overflow-x-hidden p-3 sm:p-4 md:p-5 lg:p-6">
          <InstructorGradesContent embedInDashboard />
        </div>
      </CardWrapper>
    </motion.div>
  )
