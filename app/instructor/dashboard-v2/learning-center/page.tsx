...
const QUICK_LINKS = [
  { label: "Office Hours", href: "/instructor/dashboard-v2/learning-center/office-hours", icon: Clock, desc: "Manage student office hour requests" },
  { label: "Help & Support", href: "/instructor/dashboard-v2/learning-center/help", icon: HelpCircle, desc: "Get help and access resources" },
]
