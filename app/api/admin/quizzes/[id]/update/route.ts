...
export async function PUT(request: NextRequest,
  ...
  try {
    ...
    console.log("[quiz-update] admin PUT received", { quizId })
    ...
    console.log("[v0] Updating quiz with availability:", {
      available_from_received: available_from,
      available_until_received: available_until,
