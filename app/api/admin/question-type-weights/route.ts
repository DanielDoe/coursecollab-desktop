...
export async function GET(request: NextRequest) {
  ...
  try {
    console.log("[v0] Fetching question type weights...")
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.log(`[v0] Creating weight config for ${question_type} in ${assessment_type}`)
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    console.log(`[v0] Updating weight config ID: ${id}`)
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    console.log(`[v0] Deleting weight config ID: ${id}`)
