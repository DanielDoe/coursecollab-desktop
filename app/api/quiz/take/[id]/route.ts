  ...
  try {
    ...
    const quizResult = await sql`
      SELECT 
        ...
        COALESCE(q.track_gemini_window, true) as track_gemini_window,
        COALESCE(q.max_gemini_strikes, 5) as max_gemini_strikes,
        COALESCE(q.require_fullscreen, false) as require_fullscreen,
