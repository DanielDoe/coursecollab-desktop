...
import { SystemMonitorContent } from "@/components/instructor/SystemMonitorContent"

export default function AdministrationSystemMonitorPage() {
  return (
    <motion.div
    ...
    >
      <CardWrapper delay={0} hover={false}>
        <div className="p-3 sm:p-4 md:p-5 lg:p-6 w-full min-w-0 overflow-x-hidden">
          <SystemMonitorContent embedInDashboard />
        </div>
      </CardWrapper>
    </motion.div>
  )
