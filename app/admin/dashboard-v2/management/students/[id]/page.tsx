...
import { StudentRecordView } from "@/components/instructor/StudentRecordView"
import { cn } from "@/lib/utils"
import { dashboardV2CardBodyClass } from "@/lib/dashboard-v2-layout"

export default function AdminManagementStudentRecordPage({
  params,
}: {
  ...
  return (
    ...
    >
      ...
      >
        <StudentRecordView studentDbId={id} userType="admin" embedInDashboard={false} />
      </CardWrapper>
    </motion.div>
  )
}
