...
export function GuestReportBugPage() {
    ...
    >
      ...
      >
        <div className="relative flex items-start gap-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Report a Bug</h1>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g. Résumé Match, Settings"
                    className="rounded-lg"
                  />
                </div>
                <div className="space-y-2">
