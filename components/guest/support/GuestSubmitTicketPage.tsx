...
export function GuestSubmitTicketPage() {
    ...
    >
      ...
      >
        <div className="relative flex items-start gap-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Submit Ticket</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
        ...
        <Card className="rounded-xl border shadow-sm bg-card">
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">Email: support@coursecollab.com</p>
          </CardContent>
        </Card>
      </div>
    </motion.div>
