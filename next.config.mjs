...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/instructor/ai-monitoring", destination: "/faculty/dashboard/analytics/ai-monitoring", permanent: false },
      { source: "/instructor/grades", destination: "/faculty/dashboard/assessments/grades", permanent: false },
      { source: "/instructor/ai-insights", destination: "/faculty/dashboard/analytics/ai-insights", permanent: false },
